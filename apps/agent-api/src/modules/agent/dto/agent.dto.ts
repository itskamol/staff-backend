import { IsString, IsNotEmpty, IsOptional, IsBoolean, IsInt, IsDateString, IsArray, ValidateNested, IsEnum } from 'class-validator';
...
export class ActiveWindowDataDto {
  ...
  @ApiProperty({ example: 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mP8/5+hHgAHggJ/PchI7wAAAABJRU5ErkJggg==', required: false })
  @IsOptional()
  @IsString()
  icon?: string;
