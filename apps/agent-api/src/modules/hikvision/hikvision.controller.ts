...
export class HIKVisionController {
  ...
  @ApiOperation({ 
    ...
    description: 'Receives and processes access control actions from HIKVision devices (face recognition, card swipe, etc.)'
  })
  @ApiResponse({ 
    status: 200, 
  ...
  @ApiOperation({ 
    ...
    description: 'Processes multiple access control actions in a single request for better performance'
  })
  @ApiResponse({ 
    status: 200, 
  ...
  @ApiOperation({ 
    ...
    description: 'Receives and processes system events from HIKVision devices (alarms, door status, etc.)'
  })
  @ApiResponse({ 
    status: 200, 
  ...
  @ApiOperation({ 
    ...
    description: 'Receives device status updates including health metrics, connectivity status, etc.'
  })
  @ApiResponse({ 
    status: 200, 
